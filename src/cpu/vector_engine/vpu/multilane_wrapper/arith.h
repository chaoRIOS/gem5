...
extract64(uint64_t val, int pos, int len)
{
...
static inline uint64_t
xperm(uint64_t rs1, uint64_t rs2, size_t sz_log2, size_t len)
{
    uint64_t r = 0;
